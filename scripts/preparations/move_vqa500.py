...
selected_img_ids = set(all_img_ids[:500])
print(f"Selected {len(selected_img_ids)} images for the VQA 500 subset.")
...
print("✅ VQA 500 subset successfully created in data/raw-vqa500/")
